...
static emlrtRSInfo mo_emlrtRSI = { 31, /* lineNo */
  "inv",                               /* fcnName */
  "/usr/local/MATLAB/R2019b/toolbox/eml/lib/matlab/matfun/inv.m"/* pathName */
};

static emlrtRSInfo no_emlrtRSI = { 42, /* lineNo */
  "checkcond",                         /* fcnName */
  "/usr/local/MATLAB/R2019b/toolbox/eml/lib/matlab/matfun/inv.m"/* pathName */
};

static emlrtRSInfo oo_emlrtRSI = { 46, /* lineNo */
  "checkcond",                         /* fcnName */
  "/usr/local/MATLAB/R2019b/toolbox/eml/lib/matlab/matfun/inv.m"/* pathName */
};
...
static emlrtRSInfo ar_emlrtRSI = { 53, /* lineNo */
  "flt2str",                           /* fcnName */
...
void inv(const emlrtStack *sp, const real_T x[9], real_T y[9])
{
  ...
  if ((absx21 == 0.0) || (absx31 == 0.0) || (absx11 == 0.0)) {
    ...
    if (muDoubleScalarIsNaN(absx11) || (absx11 < 2.2204460492503131E-16)) {
      ...
      emlrt_marshallIn(&c_st, c_sprintf(&c_st, b_y, c_y, &e_emlrtMCI),
