...
static emlrtMCInfo emlrtMCI = { 14,    /* lineNo */
  25,                                  /* colNo */
  "warning",                           /* fName */
  "/usr/local/MATLAB/R2019b/toolbox/shared/coder/coder/lib/+coder/+internal/warning.m"/* pName */
};
...
static emlrtRSInfo xq_emlrtRSI = { 14, /* lineNo */
  "warning",                           /* fcnName */
  "/usr/local/MATLAB/R2019b/toolbox/shared/coder/coder/lib/+coder/+internal/warning.m"/* pathName */
};
...
void c_warning(const emlrtStack *sp)
{
  ...
  c_y = NULL;
  m2 = emlrtCreateCharArray(2, iv2);
  emlrtInitCharArrayR2013a(sp, 42, m2, &msgID[0]);
  emlrtAssign(&c_y, m2);
  st.site = &xq_emlrtRSI;
  b_feval(&st, y, c_feval(&st, b_y, c_y, &emlrtMCI), &b_emlrtMCI);
}

void d_warning(const emlrtStack *sp, const char_T varargin_1[14])
{
  const mxArray *y;
  const mxArray *m;
  static const int32_T iv[2] = { 1, 7 };
...
void warning(const emlrtStack *sp, const char_T varargin_2[200])
{
  ...
  emlrtAssign(&c_y, m2);
  d_y = NULL;
  m3 = emlrtCreateDoubleScalar(8.0);
  emlrtAssign(&d_y, m3);
  e_y = NULL;
  m4 = emlrtCreateCharArray(2, iv3);
  emlrtInitCharArrayR2013a(sp, 200, m4, &varargin_2[0]);
  emlrtAssign(&e_y, m4);
  st.site = &xq_emlrtRSI;
