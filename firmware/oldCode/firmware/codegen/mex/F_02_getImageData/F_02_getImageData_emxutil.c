...
static void emxTrim_struct_T(b_emxArray_struct_T *emxArray, int32_T fromIndex,
  int32_T toIndex);
static void f_emxInitStruct_vision_internal(const emlrtStack *sp,
...
void c_emxInitStruct_vision_internal(const emlrtStack *sp,
  ...
  boolean_T doPush)
{
  d_emxInitStruct_vision_internal(sp, &pStruct->UndistortMap, srcLocation,
    doPush);
}
...
void d_emxInitStruct_vision_internal(const emlrtStack *sp,
  ...
  boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->Xmap, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Ymap, 2, srcLocation, doPush);
  ...
  boolean_T doPush)
{
  ...
  f_emxInitStruct_vision_internal(sp, &pStruct->RectificationParams, srcLocation,
    doPush);
}
  ...
  c_struct_T *src, const emlrtRTEInfo *srcLocation)
{
  ...
  emxCopy_real_T(sp, &dst->SubarrayIdx, &src->SubarrayIdx, srcLocation);
...
{
  emxInit_boolean_T(sp, &pStruct->Image, 2, srcLocation, doPush);
  emxInit_boolean_T(sp, &pStruct->FilledImage, 2, srcLocation, doPush);
...
/* End of code generation (F_02_getImageData_emxutil.c) */
