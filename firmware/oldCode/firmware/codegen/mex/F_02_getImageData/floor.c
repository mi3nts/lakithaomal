...
static emlrtRSInfo tj_emlrtRSI = { 11, /* lineNo */
  "floor",                             /* fcnName */
  "/usr/local/MATLAB/R2019b/toolbox/eml/lib/matlab/elfun/floor.m"/* pathName */
};
...
void c_floor(const emlrtStack *sp, emxArray_real_T *x)
{
  int32_T nx;
  boolean_T overflow;
  int32_T k;
